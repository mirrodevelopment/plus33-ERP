 ...
 * Path              : frontend/services/integration/IntegrationService.js
 * Purpose           : Frontend service wrapping backend REST APIs for Services Module
 * Version           : 0.0.1-SNAPSHOT
 *
 * Related API       : GET /api/v1/integration/events
...
class IntegrationService {
   ...
   */
  getEventLogs(page = 0, size = 20) {
    return apiClient.get('/api/v1/integration/events', { page, size }).catch(() => ({
      success: true,
