...
export const routes = [
  ...
  { path: '#complaints', page: 'modules/ultimate-admin/pages/complaints/ultimate-complaints.js', layout: 'dashboard', title: 'Ultimate Executive Complaints Registry', requiresAuth: true },
  { path: '#national-complaints', page: 'modules/national-admin/pages/complaints/national-complaints.js', layout: 'dashboard', title: 'National Complaints Oversight', requiresAuth: true },
  { path: '#regional-complaints', page: 'modules/regional-admin/pages/complaints/regional-complaints.js', layout: 'dashboard', title: 'Regional Complaints Overview', requiresAuth: true },
  { path: '#store-complaints', page: 'modules/store-admin/pages/complaints/store-complaints.js', layout: 'dashboard', title: 'Store Complaints Overview', requiresAuth: true },
  { path: '#regional-support', page: 'modules/regional-admin/pages/support/regional-support.js', layout: 'dashboard', title: 'Regional Operations Support', requiresAuth: true },
  { path: '#regional-help', page: 'modules/regional-admin/pages/support/regional-support.js', layout: 'dashboard', title: 'Regional Support Portal', requiresAuth: true },
  { path: '#store-support', page: 'modules/store-admin/pages/support/store-support.js', layout: 'dashboard', title: 'Store Support Hub', requiresAuth: true },
  { path: '#support', page: 'shared/support/employee-support.js', layout: 'dashboard', title: 'Help & Support Hub', requiresAuth: true },
  { path: '#help', page: 'shared/support/employee-support.js', layout: 'dashboard', title: 'Help & Support Hub', requiresAuth: true },
  ...
  // Store Admin Page Extensions
  { path: '#store-announcements', page: 'modules/store-admin/pages/announcements/announcements.js', layout: 'dashboard', title: 'Store Management Broadcasts', requiresAuth: true },

  // Regional Admin Page Extensions
  ...
  { path: '#regional-warehouse', page: 'modules/regional-admin/pages/warehouse/warehouse.js', layout: 'dashboard', title: 'Regional Warehouse Overview', requiresAuth: true },
  { path: '#regional-sales', page: 'modules/regional-admin/pages/sales/sales.js', layout: 'dashboard', title: 'Regional Sales Overview', requiresAuth: true },
  { path: '#regional-inventory', page: 'modules/regional-admin/pages/inventory/inventory.js', layout: 'dashboard', title: 'Regional Inventory Overview', requiresAuth: true },
  { path: '#regional-supply-requests', page: 'modules/regional-admin/pages/supply-requests/supply-requests.js', layout: 'dashboard', title: 'Regional Supply Requests', requiresAuth: true },
  { path: '#regional-announcements', page: 'modules/regional-admin/pages/announcements/announcements.js', layout: 'dashboard', title: 'Regional Announcements Board', requiresAuth: true },
  { path: '#regional-employees', page: 'modules/regional-admin/pages/employees/employees.js', layout: 'dashboard', title: 'Regional Employees Overview', requiresAuth: true },
  { path: '#regional-recruitment', page: 'modules/regional-admin/pages/recruitment/recruitment.js', layout: 'dashboard', title: 'Regional Recruitment Portal', requiresAuth: true },
  { path: '#regional-training', page: 'modules/regional-admin/pages/training/training.js', layout: 'dashboard', title: 'Regional Training and Development', requiresAuth: true },
  { path: '#regional-performance', page: 'modules/regional-admin/pages/performance/performance.js', layout: 'dashboard', title: 'Regional Employee Performance', requiresAuth: true },
  { path: '#regional-vendors', page: 'modules/regional-admin/pages/vendors/vendors.js', layout: 'dashboard', title: 'Regional Vendors Management', requiresAuth: true },
  { path: '#regional-purchase', page: 'modules/regional-admin/pages/purchase/purchase.js', layout: 'dashboard', title: 'Regional Purchase Orders', requiresAuth: true },
  { path: '#regional-contracts', page: 'modules/regional-admin/pages/contracts/contracts.js', layout: 'dashboard', title: 'Regional Contracts Overview', requiresAuth: true },
  { path: '#regional-legal', page: 'modules/regional-admin/pages/legal/legal.js', layout: 'dashboard', title: 'Regional Legal Cases Overview', requiresAuth: true },
  { path: '#regional-audit', page: 'modules/regional-admin/pages/audit/audit.js', layout: 'dashboard', title: 'Regional Audit & Compliance', requiresAuth: true },
  { path: '#regional-reports', page: 'modules/regional-admin/pages/reports/reports.js', layout: 'dashboard', title: 'Regional Analytical Reports', requiresAuth: true },
  { path: '#regional-analytics', page: 'modules/regional-admin/pages/analytics/analytics.js', layout: 'dashboard', title: 'Regional Metrics Analytics', requiresAuth: true },
  { path: '#regional-settings', page: 'modules/regional-admin/pages/settings/settings.js', layout: 'dashboard', title: 'Regional Administration Settings', requiresAuth: true },

  // Warehouse Logs and System Placeholders
  { path: '#logs', page: 'modules/warehouse-admin/pages/logs/logs.js', layout: 'dashboard', title: 'Warehouse Operations Logs', requiresAuth: true },
  { path: '#reports', page: 'shared/not-implemented/not-implemented.js', layout: 'dashboard', title: 'Reports Overview', requiresAuth: true },
  { path: '#insights', page: 'shared/not-implemented/not-implemented.js', layout: 'dashboard', title: 'Data Insights Portal', requiresAuth: true },
  { path: '#policies', page: 'shared/not-implemented/not-implemented.js', layout: 'dashboard', title: 'Enterprise Policies Documents', requiresAuth: true }
];
