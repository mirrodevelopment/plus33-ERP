 ...
 * File              : PlatformAccessPolicy.java
 ...
 * Related DB Table  : platform_access_policy
 * Related REST APIs : N/A
 * Depends On        : None
 * Used By           : PlatformAccessPolicyRepository, PlatformAccessPolicyMapper
 *
 * Description
 * ---------------------------------------------------------------------------
 * JPA Entity mapped to 'platform_access_policy'. Defines persistent domain object for Platform Module with validation, relationship mappings, and lifecycle callbacks.
 ******************************************************************************/
package com.plus33.erp.platform.entity;
 ...
 *
 * <p><b>Class  :</b> {@code PlatformAccessPolicy}</p>
 * <p><b>Package:</b> {@code com.plus33.erp.platform.entity}</p>
 * <p><b>Layer  :</b> JPA Entity: persistent domain object mapped to PostgreSQL table 'platform_access_policy'.</p>
 *
 * <p><b>Database Table   :</b> {@code platform_access_policy}</p>
