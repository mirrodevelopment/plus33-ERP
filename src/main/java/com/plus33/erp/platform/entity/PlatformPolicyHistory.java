 ...
 * File              : PlatformPolicyHistory.java
 ...
 * Related DB Table  : platform_policy_history
 * Related REST APIs : N/A
 * Depends On        : None
 * Used By           : PlatformPolicyHistoryRepository, PlatformPolicyHistoryMapper
 *
 * Description
 * ---------------------------------------------------------------------------
 * JPA Entity mapped to 'platform_policy_history'. Defines persistent domain object for Platform Module with validation, relationship mappings, and lifecycle callbacks.
 ******************************************************************************/
package com.plus33.erp.platform.entity;
 ...
 *
 * <p><b>Class  :</b> {@code PlatformPolicyHistory}</p>
 * <p><b>Package:</b> {@code com.plus33.erp.platform.entity}</p>
 * <p><b>Layer  :</b> JPA Entity: persistent domain object mapped to PostgreSQL table 'platform_policy_history'.</p>
 *
 * <p><b>Database Table   :</b> {@code platform_policy_history}</p>
