 ...
 * File              : StockAdjustmentRepository.java
 ...
 * Depends On        : None
 * Used By           : StockAdjustmentService, StockAdjustmentServiceImpl
 *
 * Description
 * ---------------------------------------------------------------------------
 * JPA Repository for Warehouse Module against the 'stock_adjustments' table. Provides CRUD, Specification-based queries, and paginated results.
 ******************************************************************************/
package com.plus33.erp.warehouse.repository;
 ...
 *
 * <p><b>Class  :</b> {@code StockAdjustmentRepository}</p>
 * <p><b>Package:</b> {@code com.plus33.erp.warehouse.repository}</p>
 * <p><b>Layer  :</b> JPA Repository: database access for table 'stock_adjustments' via Spring Data JPA.</p>
 *
