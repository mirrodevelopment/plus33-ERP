 ...
 * File              : SalesTaxEngineProvider.java
 * Purpose           : Component of Finance Module within the PLUS33 Coffee ERP platform
 * Version           : 0.0.1-SNAPSHOT
 *
 * Related Controller: SalesTaxEngineProviderController
 * Related Service   : SalesTaxEngineProviderService, SalesTaxEngineProviderServiceImpl
 * Related Repository: TaxRateRepository
 * Related Entity    : SalesTaxEngineProvider
 * Related DTO       : TaxCalculationLineRequest, TaxCalculationRequest
 * Related Mapper    : SalesTaxEngineProviderMapper
 * Related DB Table  : sales_tax_engine_providers
