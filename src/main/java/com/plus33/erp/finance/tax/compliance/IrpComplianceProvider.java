 ...
 * File              : IrpComplianceProvider.java
 * Purpose           : Component of Finance Module within the PLUS33 Coffee ERP platform
 * Version           : 0.0.1-SNAPSHOT
 *
 * Related Controller: IrpComplianceProviderController
 * Related Service   : IrpComplianceProviderService, IrpComplianceProviderServiceImpl
 * Related Repository: IrpComplianceProviderRepository
 * Related Entity    : IrpComplianceProvider
 * Related DTO       : N/A
 * Related Mapper    : IrpComplianceProviderMapper
 * Related DB Table  : irp_compliance_providers
 ...
 *
 * <p><b>Class  :</b> {@code IrpComplianceProvider}</p>
