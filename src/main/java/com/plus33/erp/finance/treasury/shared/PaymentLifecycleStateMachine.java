 ...
 * File              : PaymentLifecycleStateMachine.java
 * Purpose           : Component of Finance Module within the PLUS33 Coffee ERP platform
 * Version           : 0.0.1-SNAPSHOT
 *
 * Related Controller: PaymentLifecycleStateMachineController
 * Related Service   : PaymentLifecycleStateMachineService, PaymentLifecycleStateMachineServiceImpl
 * Related Repository: PaymentLifecycleStateMachineRepository
 * Related Entity    : PaymentLifecycleStateMachine
 * Related DTO       : N/A
 * Related Mapper    : PaymentLifecycleStateMachineMapper
 * Related DB Table  : payment_lifecycle_state_machines
