 ...
 * File              : FixedAssetRevaluationRepository.java
 ...
 * Depends On        : None
 * Used By           : FixedAssetRevaluationService, FixedAssetRevaluationServiceImpl
 *
 * Description
 * ---------------------------------------------------------------------------
 * JPA Repository for Finance Module against the 'fixed_asset_revaluations' table. Provides CRUD, Specification-based queries, and paginated results.
 ******************************************************************************/
package com.plus33.erp.finance.assets.repository;
 ...
 *
 * <p><b>Class  :</b> {@code FixedAssetRevaluationRepository}</p>
 * <p><b>Package:</b> {@code com.plus33.erp.finance.assets.repository}</p>
 * <p><b>Layer  :</b> JPA Repository: database access for table 'fixed_asset_revaluations' via Spring Data JPA.</p>
 *
