 ...
 * File              : PayrollPostedEvent.java
 * Purpose           : Spring ApplicationEvent published by Workforce Module for async processing
 * Version           : 0.0.1-SNAPSHOT
 *
 * Related Controller: PayrollPostedEventController
 * Related Service   : PayrollPostedEventService, PayrollPostedEventServiceImpl
 * Related Repository: PayrollPostedEventRepository
 * Related Entity    : PayrollPostedEvent
 * Related DTO       : N/A
 * Related Mapper    : PayrollPostedEventMapper
 * Related DB Table  : payroll_posted_events
...
public class PayrollPostedEvent {
    private final Long payrollRunId;
    private final Long companyId;

    public PayrollPostedEvent(Long payrollRunId, Long companyId) {
