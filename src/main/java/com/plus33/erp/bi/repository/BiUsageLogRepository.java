 ...
 * File              : BiUsageLogRepository.java
 ...
 * Related DB Table  : bi_usage_logs
 * Related REST APIs : N/A
 * Depends On        : None
 * Used By           : BiUsageLogService, BiUsageLogServiceImpl
 *
 * Description
 * ---------------------------------------------------------------------------
 * JPA Repository for Bi Module against the 'bi_usage_logs' table. Provides CRUD, Specification-based queries, and paginated results.
 ******************************************************************************/
package com.plus33.erp.bi.repository;
 ...
 *
 * <p><b>Class  :</b> {@code BiUsageLogRepository}</p>
 * <p><b>Package:</b> {@code com.plus33.erp.bi.repository}</p>
 * <p><b>Layer  :</b> JPA Repository: database access for table 'bi_usage_logs' via Spring Data JPA.</p>
 *
 * <p><b>Database Table   :</b> {@code bi_usage_logs}</p>
