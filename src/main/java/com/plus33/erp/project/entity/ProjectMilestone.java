 ...
 * Depends On        : None
 * Used By           : ProjectMilestoneRepository, ProjectMilestoneMapper
 *
 * Description
 * ---------------------------------------------------------------------------
 * JPA Entity mapped to 'project_milestones'. Defines persistent domain object for Project Module with validation, relationship mappings, and lifecycle callbacks.
 ******************************************************************************/
package com.plus33.erp.project.entity;
 ...
 *
 * <p><b>Class  :</b> {@code ProjectMilestone}</p>
 * <p><b>Package:</b> {@code com.plus33.erp.project.entity}</p>
 * <p><b>Layer  :</b> JPA Entity: persistent domain object mapped to PostgreSQL table 'project_milestones'.</p>
 *
 * <p><b>Database Table   :</b> {@code project_milestones}</p>
...
public class ProjectMilestone {
    ...
    /**
     * Retrieves completed data from the database.
     *
    ...
    /**
     * Performs the setCompleted operation in this module.
     *
     * @param completed the completed input value
     */
