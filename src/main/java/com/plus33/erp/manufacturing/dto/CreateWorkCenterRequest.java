 ...
 * File              : CreateWorkCenterRequest.java
 * Purpose           : Data Transfer Object for request/response in Manufacturing Module
 * Version           : 0.0.1-SNAPSHOT
 *
 * Related Controller: CreateWorkCenterController
 * Related Service   : CreateWorkCenterService, CreateWorkCenterServiceImpl
 * Related Repository: CreateWorkCenterRepository
 * Related Entity    : CreateWorkCenter
 * Related DTO       : CreateWorkCenterRequest
 * Related Mapper    : CreateWorkCenterMapper
 * Related DB Table  : create_work_centers
 * Related REST APIs : N/A
 * Depends On        : None
 * Used By           : CreateWorkCenterController, CreateWorkCenterService, CreateWorkCenterServiceImpl
 *
 * Description
 * ---------------------------------------------------------------------------
...
public class CreateWorkCenterRequest {
    ...
    private String workCenterType; // MACHINE, LABOR, MIXED, SUBCONTRACT
    private BigDecimal machineCapacity;
    private BigDecimal laborCapacity;
    private BigDecimal hourlyMachineRate;
    @NotNull private BigDecimal hourlyLaborRate;
    @NotNull private BigDecimal hourlyOverheadRate;
    @NotNull private BigDecimal capacityHoursPerDay;
    ...
    public CreateWorkCenterRequest() {}
