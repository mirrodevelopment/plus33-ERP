 ...
 * File              : CreateEcoLineRequest.java
 * Purpose           : Data Transfer Object for request/response in Manufacturing Module
 * Version           : 0.0.1-SNAPSHOT
 *
 * Related Controller: CreateEcoLineController
 * Related Service   : CreateEcoLineService, CreateEcoLineServiceImpl
 * Related Repository: CreateEcoLineRepository
 * Related Entity    : CreateEcoLine
 * Related DTO       : CreateEcoLineRequest
 * Related Mapper    : CreateEcoLineMapper
 * Related DB Table  : create_eco_lines
 * Related REST APIs : N/A
 * Depends On        : None
 * Used By           : CreateEcoLineController, CreateEcoLineService, CreateEcoLineServiceImpl
 *
 * Description
 * ---------------------------------------------------------------------------
